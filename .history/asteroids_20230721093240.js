...
function update() {
    ...
    if (ship.thrusting) {
        ...
        if (!exploding && blinkOn) {
            ...
            con.lineTo( // rear centre (behind the ship)
                ship.x - ship.r * 5 / 3 * Math.cos(ship.a),
                ship.y + ship.r * 5 / 3 * Math.sin(ship.a)
            );
            con.lineTo( // rear right
                ship.x - ship.r * (2 / 3 * Math.cos(ship.a) - 0.5 * Math.sin(ship.a)),
                ship.y + ship.r * (2 / 3 * Math.sin(ship.a) + 0.5 * Math.cos(ship.a))
            );
            con.closePath();
    ...
    if (!exploding) {
        if (blinkOn) {
            ...
            con.lineWidth = SHIP_SIZE / 20;
            con.beginPath();
            con.moveTo( // nose of the ship
                ship.x + 4 / 3 * ship.r * Math.cos(ship.a),
                ship.y - 4 / 3 * ship.r * Math.sin(ship.a)
            );
            con.lineTo( // rear left
        ...
        con.fillStyle = "darkred";
        con.beginPath();
        con.arc(ship.x, ship.y, ship.r * 1.7, 0, Math.PI * 2, false);
        con.fill();
        con.fillStyle = "red";
        con.beginPath();
        con.arc(ship.x, ship.y, ship.r * 1.4, 0, Math.PI * 2, false);
        con.fill();
        con.fillStyle = "orange";
        con.beginPath();
        con.arc(ship.x, ship.y, ship.r * 1.1, 0, Math.PI * 2, false);
        con.fill();
        con.fillStyle = "yellow";
        con.beginPath();
        con.arc(ship.x, ship.y, ship.r * 0.8, 0, Math.PI * 2, false);
        con.fill();
        con.fillStyle = "white";
        con.beginPath();
        con.arc(ship.x, ship.y, ship.r * 0.5, 0, Math.PI * 2, false);
        con.fill();
    }
    ...
    if (SHOW_BOUNDING) {
        ...
        con.beginPath();
        con.arc(ship.x, ship.y, ship.r, 0, Math.PI * 2, false);
        con.stroke();
    }
    ...
    if (SHOW_CENTRE_DOT) {
        con.fillStyle = "red";
        con.fillRect(ship.x - 1, ship.y - 1, 2, 2);
    }
