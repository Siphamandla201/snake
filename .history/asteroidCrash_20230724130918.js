        ...
        const SHIP_BLINK_DURATIO = 0.1; // duration in seconds of a single blink during ship's invisibility
        ...
        function newShip() {
            return {
                ...
                r: SHIP_SIZE / 2,
                blinkNum: Math.ceil(SHIP_INV_DUR / SHIP_BLINK_DURATIO),
                blinkTime: Math.ceil(SHIP_BLINK_DURATIO * FPS),
                explodeTime: 0,
                rot: 0,
                thrusting: false,
                thrust: {
        ...
        function update() {
            ...
            if (!exploding) {
                ...
                if (ship.blinkNum > 0) {
                    ...
                    if (ship.blinkTime == 0) {
                        ship.blinkTime = Math.ceil(SHIP_BLINK_DURATIO * FPS);
                        ship.blinkNum--;
                    }
                }
            } else {
