        ...
        const ASTEROID_JAGGED = 0.4; // jaggedness of the asteroids (0 = none, 1 = lots)
        ...
        const ASTEROID_VERTEX = 10; // average number of vertices on each asteroid
        ...
        function newAsteroid(x, y) {
            var asroid = {
                ...
                r: ASTEROID_SIZE / 2,
                offs: [],
                vert: Math.floor(Math.random() * (ASTEROID_VERTEX + 1) + ASTEROID_VERTEX / 2)
            };

            // populate the offsets array
            for (var i = 0; i < asroid.vert; i++) {
                asroid.offs.push(Math.random() * ASTEROID_JAGGED * 2 + 1 - ASTEROID_JAGGED);
            }
