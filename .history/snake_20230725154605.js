...
function checkBoundaries() {
    ...
    if (snake.y < 0) {  // Check for collision with top walls
        gameOver = true;
        snake.yv = 0; 
        snake.y = 0 + snake.snakeBody.length; // Keep the snake at the top edge of the board
    
    } else if (snake.y + blockSize > board.height) {  // Check for collision bottom walls
        gameOver = true;
        snake.yv = 0;
        snake.y = board.height - (blockSize + snake.snakeBody.length); // Keep the snake at the bottom edge of the board
