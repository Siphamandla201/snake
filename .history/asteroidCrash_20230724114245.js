...
class Player {
  ...
  draw() {
    ...
    c.rotate(this.rotation + this.angle)
    c.translate(-this.position.x, -this.position.y)
  ...
  getVertices() {
    const cos = Math.cos(this.rotation + this.angle)
    const sin = Math.sin(this.rotation + this.angle)
...
const SPEED = 3
const ROTATIONAL_SPEED = 3 * Math.PI / 180)
const FRICTION = 0.97
