...
function update() {
    ...
    for (var i = 0; i < asteroids.length; i++) {
        ...
        if (asteroids[i].x < 0 - asteroids[i].r) {
            asteroids[i].x = boa.width + asteroids[i].r;
        } else if (asteroids[i].x > boa.width + asteroids[i].r) {
            asteroids[i].x = 0 - asteroids[i].r
        }
        if (asteroids[i].y < 0 - asteroids[i].r) {
            asteroids[i].y = boa.height + asteroids[i].r;
        } else if (asteroids[i].y > boa.height + asteroids[i].r) {
