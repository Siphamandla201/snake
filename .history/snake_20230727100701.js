...
snake.snaketail.tailX = snake.x + blockSize - 10;
snake.snaketail.tailY = snake.y + blockSize;
...
function drawSnake() {
    ...
    context.drawImage(snakeImg, snake.x, snake.y, blockSize + 5, blockSize + 5);
    ...
    context.fillStyle = 'lightblue';
    context.drawImage(snakeImg, snake.snaketail.tailX, snake.snaketail.tailY, blockSize, blockSize);
}
