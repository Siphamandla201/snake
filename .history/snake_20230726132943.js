...
function liveLeft() {
    if (gameOver) {
        if (gameLives > 0) {
            ...
            context.fillStyle = "white"; // Set the color for the text
            context.font = "40px Arial"; // Set the font for the text
            context.fillText(`you have ${gameLives} left`, 180, 50); // Render the text
