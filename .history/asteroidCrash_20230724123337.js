...
let ship = {
  ...
  function drawShip(x, y, a) {
    ...
    context.moveTo( // nose of the ship
        ship.x + ship.r * Math.cos(a),
        ship.y - ship.r * Math.sin(a)
    );
    context.lineTo( // rear left
    ship.x + ship.r * (Math.cos(a)+ Math.cos(a) ),
    ship.y - ship.r * (Math.sin(a) - Math.sin(a) )
    );
    context.lineTo( // rear right
        ship.x - ship.r * (2 /Math.cos(a) - Math.sin(a)),
        ship.y + ship.r * (2 /Math.sin(a) + Math.cos(a))
    );
    context.closePath();
    context.stroke();
  }
