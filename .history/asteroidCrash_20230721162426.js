...
function animateShip() {
    ...
    if (buttons.ArrowRight.pressed == true) {
        ...
        ship.rotate = Math.PI / 01; // Rotate ship clockwise by 1 degree (adjust as needed)
    } else if (buttons.ArrowLeft.pressed == true) {
        ship.velocity.velocityX = -1;
        ship.rotate = -Math.PI / 0.1; // Rotate ship anti-clockwise by 1 degree (adjust as needed)
    } 
