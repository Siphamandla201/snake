...
function keyDown(event) {
    ...
    if (buttons.ArrowRight.pressed) {
        ship.rotate = Math.PI / 180; // Rotate ship clockwise by 1 degree (adjust as needed)
    } else if (buttons.ArrowLeft.pressed) {
        ship.rotate = -Math.PI / 180; // Rotate ship counterclockwise by 1 degree (adjust as needed)
    }
}
