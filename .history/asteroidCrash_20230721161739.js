...
Save to grepper
With this update, the ship should now be centered in the middle of the canvas and will rotate correctly based on the this.rotate value. The ship will move smoothly in the direction you specify using the arrow keys. If 
