...
function checkBoundaries() {
    ...
    if (snake.y < 0) {
        ...
        snake.y = board.height - blockSize;; // Keep the snake at the top edge of the board
        alive = false
        gameOver = true;
    } else if (snake.y + blockSize > board.height) {
        snake.yv = -1; // Reverse the vertical direction to move upwards
