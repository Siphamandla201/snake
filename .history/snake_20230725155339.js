...
function checkBoundaries() {
    let snakeBody = snake.snakeBody.length
    ...
    if (snake.x < 0 ) {
        ...
        gameOver = true;
        snake.x = board.width - (blockSize + snakeBody);
    }
    ...
    if (snake.y < 0) {  // Check for collision with top 
        ...
        gameOver = true;
        snake.yv = 0;
        snake.y = (board.height - blockSize) + (board.height - + snakeBody) 30; // Keep the snake at the bottom edge of the board
